...
public class editCourse extends JFrame{
	public editCourse() {
		JLabel label0=new JLabel("EDIT COURSE");
		...
		Component[] allComponents = {label1,label2, label3, label4, label5, label6,
				field1, field2, field3, field6, chooser, box,
		                              button1, button2};
        ...
        label2.setBounds(610, 120, 200, 25);
        field2.setBounds(780, 120, 200, 25);

        label3.setBounds(610, 160, 200, 25);
        field3.setBounds(780, 160, 200, 25);

        label4.setBounds(610, 200, 200, 25);
        box.setBounds(780, 200, 200, 25);

        label5.setBounds(610, 240, 200, 25);
        chooser.setBounds(780, 240, 200, 25);

        label6.setBounds(610, 280, 200, 25);
        field6.setBounds(780, 280, 200, 25);
        ...
        button1.addActionListener(e ->{
            ...
            try {
				PreparedStatement ps=Conn.getConnection().prepareStatement("update course set name=?, mentor=?,status=?,ldate=?,duration=? where id=?;");
				ps.setString(1, name);
